...
var file_amornotification_amornotification_proto_rawDesc = string([]byte{
...
var (
	...
	file_amornotification_amornotification_proto_rawDescData []byte
)
...
func file_amornotification_amornotification_proto_rawDescGZIP() []byte {
	file_amornotification_amornotification_proto_rawDescOnce.Do(func() {
		file_amornotification_amornotification_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_amornotification_amornotification_proto_rawDesc), len(file_amornotification_amornotification_proto_rawDesc)))
	})
...
func file_amornotification_amornotification_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_amornotification_amornotification_proto_rawDesc), len(file_amornotification_amornotification_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   1,
