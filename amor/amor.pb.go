...
var file_amor_amor_proto_rawDesc = []byte{
	...
	0x6f, 0x22, 0x11, 0x0a, 0x0f, 0x4c, 0x69, 0x73, 0x74, 0x48, 0x6f, 0x6d, 0x65, 0x52, 0x65, 0x71,
	...
	0x65, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x04, 0x6e, 0x61, 0x6d, 0x65, 0x32, 0xc6, 0x04,
	...
	0x72, 0x65, 0x61, 0x64, 0x30, 0x01, 0x42, 0x2a, 0x5a, 0x28, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62,
...
var file_amor_amor_proto_goTypes = []interface{}{
	...
	(*amor_var.Owner)(nil),     // 8: Owner
	(*amor_var.Utilities)(nil), // 9: Utilities
	(*empty.Empty)(nil),        // 10: google.protobuf.Empty
}
var file_amor_amor_proto_depIdxs = []int32{
	8,  // 0: projectamor_api.amor.v1.GetHomeResponse.owner:type_name -> Owner
	9,  // 1: projectamor_api.amor.v1.GetHomeResponse.utilities:type_name -> Utilities
	6,  // 2: projectamor_api.amor.v1.ProjectAmor.AddHome:input_type -> projectamor_api.amor.v1.AddHomeRequest
	5,  // 3: projectamor_api.amor.v1.ProjectAmor.DeleteHome:input_type -> projectamor_api.amor.v1.DeleteHomeRequest
	4,  // 4: projectamor_api.amor.v1.ProjectAmor.UpdateHome:input_type -> projectamor_api.amor.v1.UpdateHomeRequest
	2,  // 5: projectamor_api.amor.v1.ProjectAmor.GetHome:input_type -> projectamor_api.amor.v1.GetHomeRequest
	0,  // 6: projectamor_api.amor.v1.ProjectAmor.ListHome:input_type -> projectamor_api.amor.v1.ListHomeRequest
	7,  // 7: projectamor_api.amor.v1.ProjectAmor.AddHome:output_type -> projectamor_api.amor.v1.AddHomeResponse
	10, // 8: projectamor_api.amor.v1.ProjectAmor.DeleteHome:output_type -> google.protobuf.Empty
	10, // 9: projectamor_api.amor.v1.ProjectAmor.UpdateHome:output_type -> google.protobuf.Empty
	3,  // 10: projectamor_api.amor.v1.ProjectAmor.GetHome:output_type -> projectamor_api.amor.v1.GetHomeResponse
	1,  // 11: projectamor_api.amor.v1.ProjectAmor.ListHome:output_type -> projectamor_api.amor.v1.ListHomeResponse
