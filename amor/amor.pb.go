...
var file_amor_amor_proto_rawDesc = []byte{
	...
	0x69, 0x64, 0x22, 0x8f, 0x01, 0x0a, 0x0f, 0x47, 0x65, 0x74, 0x55, 0x73, 0x65, 0x72, 0x52, 0x65,
	0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x0e, 0x0a, 0x02, 0x69, 0x64, 0x18, 0x01, 0x20, 0x01,
	0x28, 0x03, 0x52, 0x02, 0x69, 0x64, 0x12, 0x12, 0x0a, 0x04, 0x6e, 0x61, 0x6d, 0x65, 0x18, 0x02,
	0x20, 0x01, 0x28, 0x09, 0x52, 0x04, 0x6e, 0x61, 0x6d, 0x65, 0x12, 0x10, 0x0a, 0x03, 0x61, 0x67,
	0x65, 0x18, 0x03, 0x20, 0x01, 0x28, 0x03, 0x52, 0x03, 0x61, 0x67, 0x65, 0x12, 0x23, 0x0a, 0x0d,
	...
	0x6d, 0x62, 0x65, 0x72, 0x22, 0x81, 0x02, 0x0a, 0x13, 0x52, 0x65, 0x67, 0x69, 0x73, 0x74, 0x65,
	...
	0x73, 0x77, 0x6f, 0x72, 0x64, 0x22, 0x36, 0x0a, 0x11, 0x4c, 0x6f, 0x67, 0x69, 0x6e, 0x55, 0x73,
	...
	0x20, 0x01, 0x28, 0x09, 0x52, 0x04, 0x6e, 0x61, 0x6d, 0x65, 0x32, 0xc7, 0x09, 0x0a, 0x0b, 0x50,
	...
	0x73, 0x0a, 0x07, 0x47, 0x65, 0x74, 0x55, 0x73, 0x65, 0x72, 0x12, 0x27, 0x2e, 0x70, 0x72, 0x6f,
	0x6a, 0x65, 0x63, 0x74, 0x61, 0x6d, 0x6f, 0x72, 0x5f, 0x61, 0x70, 0x69, 0x2e, 0x61, 0x6d, 0x6f,
...
var file_amor_amor_proto_goTypes = []interface{}{
	...
	(*amor_var.Room)(nil),        // 18: Room
	(*amor_var.Owner)(nil),       // 19: Owner
	(*amor_var.Utilities)(nil),   // 20: Utilities
	(*empty.Empty)(nil),          // 21: google.protobuf.Empty
}
var file_amor_amor_proto_depIdxs = []int32{
	18, // 0: projectamor_api.amor.v1.ListRoomResponse.room:type_name -> Room
	19, // 1: projectamor_api.amor.v1.GetHomeResponse.owner:type_name -> Owner
	20, // 2: projectamor_api.amor.v1.GetHomeResponse.utilities:type_name -> Utilities
	16, // 3: projectamor_api.amor.v1.ProjectAmor.AddHome:input_type -> projectamor_api.amor.v1.AddHomeRequest
	15, // 4: projectamor_api.amor.v1.ProjectAmor.DeleteHome:input_type -> projectamor_api.amor.v1.DeleteHomeRequest
	14, // 5: projectamor_api.amor.v1.ProjectAmor.UpdateHome:input_type -> projectamor_api.amor.v1.UpdateHomeRequest
	12, // 6: projectamor_api.amor.v1.ProjectAmor.GetHome:input_type -> projectamor_api.amor.v1.GetHomeRequest
	10, // 7: projectamor_api.amor.v1.ProjectAmor.ListHome:input_type -> projectamor_api.amor.v1.ListHomeRequest
	9,  // 8: projectamor_api.amor.v1.ProjectAmor.GetRoom:input_type -> projectamor_api.amor.v1.GetRoomRequest
	7,  // 9: projectamor_api.amor.v1.ProjectAmor.ListRoom:input_type -> projectamor_api.amor.v1.ListRoomRequest
	2,  // 10: projectamor_api.amor.v1.ProjectAmor.RegisterUser:input_type -> projectamor_api.amor.v1.RegisterUserRequest
	4,  // 11: projectamor_api.amor.v1.ProjectAmor.LoginUser:input_type -> projectamor_api.amor.v1.LoginUserRequest
	0,  // 12: projectamor_api.amor.v1.ProjectAmor.GetUser:input_type -> projectamor_api.amor.v1.GetUserRequest
	17, // 13: projectamor_api.amor.v1.ProjectAmor.AddHome:output_type -> projectamor_api.amor.v1.AddHomeResponse
	21, // 14: projectamor_api.amor.v1.ProjectAmor.DeleteHome:output_type -> google.protobuf.Empty
	21, // 15: projectamor_api.amor.v1.ProjectAmor.UpdateHome:output_type -> google.protobuf.Empty
	13, // 16: projectamor_api.amor.v1.ProjectAmor.GetHome:output_type -> projectamor_api.amor.v1.GetHomeResponse
	11, // 17: projectamor_api.amor.v1.ProjectAmor.ListHome:output_type -> projectamor_api.amor.v1.ListHomeResponse
	8,  // 18: projectamor_api.amor.v1.ProjectAmor.GetRoom:output_type -> projectamor_api.amor.v1.GetRoomResponse
	6,  // 19: projectamor_api.amor.v1.ProjectAmor.ListRoom:output_type -> projectamor_api.amor.v1.ListRoomResponse
	3,  // 20: projectamor_api.amor.v1.ProjectAmor.RegisterUser:output_type -> projectamor_api.amor.v1.RegisterUserResponse
	5,  // 21: projectamor_api.amor.v1.ProjectAmor.LoginUser:output_type -> projectamor_api.amor.v1.LoginUserResponse
	1,  // 22: projectamor_api.amor.v1.ProjectAmor.GetUser:output_type -> projectamor_api.amor.v1.GetUserResponse
