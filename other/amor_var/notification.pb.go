...
var file_other_amor_var_notification_proto_goTypes = []interface{}{
...
func file_other_amor_var_notification_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_other_amor_var_notification_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_other_amor_var_notification_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*Notification_NewRoomReservationOption); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_other_amor_var_notification_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*Notification_CancelRoomReservation); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
	...
	file_other_amor_var_notification_proto_msgTypes[0].OneofWrappers = []interface{}{
