...
var file_other_amor_var_home_proto_rawDesc = string([]byte{
...
var (
	...
	file_other_amor_var_home_proto_rawDescData []byte
)

func file_other_amor_var_home_proto_rawDescGZIP() []byte {
	file_other_amor_var_home_proto_rawDescOnce.Do(func() {
		file_other_amor_var_home_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_other_amor_var_home_proto_rawDesc), len(file_other_amor_var_home_proto_rawDesc)))
	})
...
var file_other_amor_var_home_proto_goTypes = []any{
...
func file_other_amor_var_home_proto_init() {
	...
	file_other_amor_var_home_proto_msgTypes[0].OneofWrappers = []any{}
	file_other_amor_var_home_proto_msgTypes[1].OneofWrappers = []any{}
	file_other_amor_var_home_proto_msgTypes[3].OneofWrappers = []any{}
	file_other_amor_var_home_proto_msgTypes[6].OneofWrappers = []any{}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_other_amor_var_home_proto_rawDesc), len(file_other_amor_var_home_proto_rawDesc)),
			NumEnums:      1,
			NumMessages:   7,
			NumExtensions: 0,
			NumServices:   0,
